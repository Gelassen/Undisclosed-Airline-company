...
KAFKA_BROKER_HOST="172.16.254.3"
...
class ForecastService:
    def __init__(self):
        ...
        self.kafka_host = KAFKA_BROKER_HOST # os.environ.get('KAFKA_BROKER_HOST')
        self.kafka_port = KAFKA_BROKER_PORT # os.environ.get('KAFKA_BROKER_PORT')
        self.kafka_topic = KAFKA_TOPIC # os.environ.get('KAFKA_TOPIC')
